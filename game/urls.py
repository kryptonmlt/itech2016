...
urlpatterns = patterns('',
                       ...
                       url(r'^updateEnemies/$', views.updateEnemies, name='updateEnemies'),
                       url(r'^collect/$', views.collect, name='collect'),
                       url(r'^remaining_collect/$', views.remaining_collect, name='remaining_collect'),
                       ...
                       url(r'^alliance_request/(?P<alliance_slug>[\w\-]+)/$', views.alliance_request,
                       ...
                       url(r'^alliance/(?P<alliance_slug>[\w\-]+)/$', views.alliance, name='alliance'),
